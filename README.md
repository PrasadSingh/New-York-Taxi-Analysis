...
Train the Random Forest Regression model with optimized hyperparameters.

Evaluate the model using regression metrics and analyze the performance.

Visualize the results to understand prediction patterns and discrepancies.
